...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item active" href="mlogin.php">Medewerker</a></li>
                        </ul>
                    </li>
                    <?php   
                     } else {
    ...
    <div class="container">
        ...
        <form action="includes/newship.inc.php" method="POST">
            <div class="mb-3">
                <label for="inputName" class="form-label">Naam</label>
                <input type="text" class="form-control" id="inputEmail" name="name" aria-describedby="inputName">
            </div>
